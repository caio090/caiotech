...
export default function ContentosConfigPage() {
  ...
  return (
    <div>
      <PageHeader title="Configurações" description="Preferências da REC OS" />
      <div className="max-w-2xl space-y-4">
        ...
        {hasMarcaData ? (
          ...
          <div className="bg-purple-50 border border-purple-100 rounded-2xl p-5">
            ...
            <p className="text-xs text-purple-600 mb-3">Complete o onboarding para personalizar a REC OS com os dados da sua marca.</p>
