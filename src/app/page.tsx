          ...
          <div className="max-w-3xl mx-auto px-4 md:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-white text-green-700 text-sm font-bold px-6 py-3 rounded-xl border border-green-200 hover:border-green-400 hover:bg-green-50 active:scale-[.98] transition-all"
                style={{ fontFamily: "'Space Grotesk', sans-serif" }}
              >
