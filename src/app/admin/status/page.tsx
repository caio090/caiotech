...
const MODULES: Module[] = [
  ...
  { name: "Central de Contas",  desc: "/admin/super/accounts — rastreio de cadastros, tipos, ações. SQL 70 aplicado.", status: "parcial", notes: "Validação admin pós-login pendente" },
