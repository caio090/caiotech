...
/**
 * Prompt 16 (REC OS Persistence Completion) — Fase 24/42: hidrata uma
 * série (com items) pra reconstruir o SeriesPanel depois de um
 * refresh. RLS (via client Supabase da sessão) é a autorização real
 * aqui -- uma série de outra Company nunca aparece, sem precisar
 * revelar se o id existe ou não (mesmo 404 genérico pros dois casos,
 * mesmo princípio de "nunca revelar existência" já usado em
 * validateExplicitCompany).
 */
