...
export const COMMAND_CENTER_METRICS: CommandCenterMetric[] = [
  ...
  metric({ id: "cmv_actual", label: "CMV real", value: 37, formattedValue: pct(37), comparison: "+1,8 p.p.", period: "Junho de 2026", source: "Inventário + Compras", updatedAt: calculatedAt, nature: "calculated", confidence: "medium", state: "simulated", tooltip: "Consumo real sobre vendas", destination: "cmv_menu", destinationDetail: "CMV real", formula: "(estoque inicial + compras - estoque final) ÷ vendas", inputs: [{ label: "Estoque inicial", value: 1200000, unit: "centavos", source: "Inventário simulado" }, { label: "Compras", value: 3500000, unit: "centavos", source: "Compras simuladas" }, { label: "Estoque final", value: 1000000, unit: "centavos", source: "Inventário simulado" }, { label: "Vendas", value: 10000000, unit: "centavos", source: "Cardápio digital simulado" }] }),
  metric({ id: "cmv_theoretical", label: "CMV teórico", value: 33, formattedValue: pct(33), comparison: "meta 32%", period: "Junho de 2026", source: "Fichas técnicas", updatedAt: calculatedAt, nature: "calculated", confidence: "medium", state: "simulated", tooltip: "Consumo esperado sobre vendas", destination: "technical_sheets", destinationDetail: "Fichas técnicas", formula: "consumo teórico ÷ vendas", inputs: [{ label: "Consumo teórico", value: 3300000, unit: "centavos", source: "Fichas técnicas simuladas" }, { label: "Vendas", value: 10000000, unit: "centavos", source: "Cardápio digital simulado" }] }),
  metric({ id: "cmv_gap", label: "Lacuna de CMV", value: 4, formattedValue: "4,0 p.p.", comparison: brl(400000), period: "Junho de 2026", source: "Cálculos Lokat", updatedAt: calculatedAt, nature: "calculated", confidence: "medium", state: "simulated", tooltip: "Diferença entre CMV real e teórico", destination: "cmv_menu", destinationDetail: "Diferença e investigação", alert: "Acima da meta simulada", formula: "CMV real - CMV teórico", inputs: [{ label: "CMV real", value: 37, unit: "%", source: "Cálculos Lokat" }, { label: "CMV teórico", value: 33, unit: "%", source: "Cálculos Lokat" }] }),
  metric({ id: "cash_balance", label: "Saldo atual", value: 1845000, formattedValue: brl(1845000), comparison: "+5,2%", period: "Junho de 2026", source: "Fluxo de caixa simulado", updatedAt: calculatedAt, nature: "simulated", confidence: "low", state: "simulated", tooltip: "Entradas menos saídas acumuladas", destination: "finance", destinationDetail: "Resumo", formula: "saldo inicial + entradas - saídas", inputs: [{ label: "Saldo", value: 1845000, unit: "centavos", source: "Fluxo de caixa simulado" }] }),
  metric({ id: "stock_value", label: "Valor em estoque", value: 1000000, formattedValue: brl(1000000), comparison: "-4,0%", period: "30/06/2026", source: "Inventário simulado", updatedAt: calculatedAt, nature: "simulated", confidence: "medium", state: "simulated", tooltip: "Quantidade por custo médio", destination: "stock", destinationDetail: "Visão geral", formula: "Σ quantidade × custo médio", inputs: [{ label: "Estoque final", value: 1000000, unit: "centavos", source: "Inventário simulado" }] }),
  metric({ id: "reserve_days", label: "Cobertura sem vendas", value: 18, formattedValue: "18 dias", comparison: "meta 30 dias", period: "Junho de 2026", source: "Cálculos Lokat", updatedAt: calculatedAt, nature: "calculated", confidence: "low", state: "simulated", tooltip: "Caixa disponível sobre gasto médio diário", destination: "finance", destinationDetail: "Reserva", alert: "Reserva abaixo da meta simulada", formula: "caixa disponível ÷ gasto médio diário", inputs: [{ label: "Cobertura", value: 18, unit: "dias", source: "Cálculos Lokat" }] }),
];

export const COMMAND_CENTER_ALERTS: BusinessAlert[] = [
  { id: "cmv-gap", priority: "high", title: "CMV real acima do teórico", explanation: "Há 4 p.p. ainda não explicados.", impact: "Pode reduzir a margem do período.", origin: "Cálculos Lokat", sector: "CMV", action: "Conferir inventário e compras", destination: "cmv_menu", destinationDetail: "Diferença e investigação", suggestedOwner: "Gestor de operações", status: "open" },
  { id: "missing-sheet", priority: "medium", title: "Produto sem ficha completa", explanation: "Um produto vendido não tem custo integral.", impact: "Reduz a cobertura do CMV teórico.", origin: "Fichas técnicas", sector: "Produtos", action: "Completar ficha", destination: "products_pricing", destinationDetail: "Fichas técnicas", suggestedOwner: "Cozinha", status: "open" },
  { id: "reserve", priority: "medium", title: "Reserva abaixo da meta", explanation: "A cobertura simulada é de 18 dias.", impact: "Menor proteção contra queda de vendas.", origin: "Financeiro", sector: "Financeiro", action: "Revisar plano de reserva", destination: "finance", destinationDetail: "Reserva", suggestedOwner: "Financeiro", status: "monitoring" },
];
