...
export function LokatVoicePanel() {
  ...
  return (
    <>
      ...
      <button
        onClick={handleOpen}
        className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-105"
        title="Lokat Voice"
