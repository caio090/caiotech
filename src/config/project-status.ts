...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  },
  {
    ...
    name: "EditorOS",
    category: "conteudo",
    description: "Editor canvas real no navegador: HTML5 Canvas, presets Feed/Story/Carrossel, texto/imagem/forma, move/resize/rotaciona/duplica, undo/redo, zoom, exportação PNG, rascunho localStorage isolado por clientId. Sprint 3.0.1: return_to sanitizado server-side, botão Voltar ao conteúdo, bridge sessionStorage de imagem temporária.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "not_started" },
    sql_dependency: "SQL 87 — design_projects (persistência em nuvem bloqueada até execução)",
    last_updated: "2026-07-16",
    notes: "Sprint 3.0.1: return_to aceito/sanitizado em page.tsx; EditorOSWorkspace exibe Voltar ao conteúdo; CanvasEditor detecta rec_os_visual_import_v1_{clientId}_{contentId} em sessionStorage e oferece Adicionar ao canvas / Descartar.",
  },
  {
  ...
  },
  {
    ...
    qa: { status: "not_started" },
    last_updated: "2026-07-16",
    notes: "Sprint 3.0.1 (Claude Code): GuidedCreateFlow reescrito. Sprint 3.0.2 (hotfix): mensagens de erro mapeadas por status HTTP (401/403/404/503/500). QA Codex Web pendente.",
  },
  {
    ...
    qa: { status: "not_started" },
    last_updated: "2026-07-16",
    notes: "Sprint 3.0.2 hotfix: RLS bloqueava INSERT em content_items. Todas as rotas API agora usam requireAdminContentOSContext() — authClient só para auth/role, adminDb para DB. Nenhum SQL executado. Nenhuma RLS alterada.",
  },
  {
    ...
    qa: { status: "not_started" },
    last_updated: "2026-07-16",
    notes: "Sprint 3.0.1: aprovacoes/page.tsx busca company_name e repassa ao ContentosAprovacoesContent. isDemo = false quando activeClientId presente. ContentosSubNavServer com initialClientId em home/campanhas/criar/calendario/resultados/producao/aprovacoes.",
  },
  {
    ...
    qa: { status: "not_started" },
    last_updated: "2026-07-16",
    notes: "Sprint 3.0.3 (P1): send-to-production setava status 'producao' mas página filtrava apenas 'em_producao' (legado). Corrigido: adminDb, filtro expandido, seção de operational_tasks, URL params, microcopy diferenciado existed=true/false.",
  },
  {
    ...
    qa: { status: "not_started" },
    last_updated: "2026-07-16",
    notes: "Sprint 3.0.3 (P1): aprovacoes/page.tsx usava createServerSupabaseClient para approvals — RLS bloqueava. Corrigido: requireAdminContentOSContext + adminDb. Microcopy diferenciado existed=true/false, IDs completos com Copy.",
  },
  {
