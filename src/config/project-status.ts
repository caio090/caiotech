...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  },
  {
    ...
    qa: {
      ...
      auditor: "Codex Web",
      result: [
        "Autenticação, rota, sidebar, isolamento Duh/O Pedreirão aprovados (2º QA)",
        "Lista completa de clientes, client/source direto na URL, estados vazios aprovados (2º QA)",
      ...
      p2: [
        ...
        "P1 (Sprint 3.1A.2): anterior/próximo/Hoje viraram Links determinísticos via buildGlobalCalendarHref/shiftMonth",
        "P1 (Sprint 3.1A.2): selects de cliente/fonte agora atualizam a URL de forma confiável",
