...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  },
  {
    ...
    qa: { status: "not_started" },
    last_updated: "2026-07-16",
    notes: "Sprint 3.0.1 (Claude Code): GuidedCreateFlow reescrito com props initialDraft/initialContentId, estado de salvamento (idle/saving/saved/error), autosave 1400ms, bridge visual sessionStorage, destinos reais via API. QA Codex Web pendente.",
  },
  {
    id: "guided_create_persistence",
    name: "REC OS — Persistência do Rascunho",
    category: "banco",
    description: "APIs: POST /drafts (cria content_item status ideia), GET /drafts/[id], PATCH /drafts/[id] (preserva metadata externa). send-to-production e send-to-approval idempotentes. Sem novos SQLs. Usa content_items.metadata jsonb (SQL 23).",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "not_started" },
    last_updated: "2026-07-16",
    notes: "Sprint 3.0.1: 4 rotas API criadas em src/app/api/admin/contentos/. Idempotência verificada em operational_tasks e approvals. SQL 82/84-90 não executados.",
  },
  {
