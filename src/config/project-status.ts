...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  // ── Workspaces 1.0.1 (mesma branch feat/workspace-panels-v1) ──────────────
  {
    ...
    next_actions: [
      ...
      "Rodar tsc --noEmit / next build / next dev / atomic-exit-endpoint.e2e.test.ts assim que o ambiente local voltar a suportar mais de ~750MB por processo Node — não foi possível localmente nesta sprint (ver notas acima)",
    ],
  },
  {
