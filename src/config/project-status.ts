...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  },
  {
    ...
    category: "admin",
    description: "Visualização consolidada (resumo executivo, 4 Ps, SWOT, metas, canais, restrições) derivada ao vivo do DNA do Negócio — não é uma cópia separada dos dados.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "pending" },
    last_updated: "2026-07-20",
    notes: "Somente na branch feat/product-engineering-preview-v1. Sem geração de PDF nesta sprint.",
  },
  {
    id: "business_four_ps",
  ...
  },
  {
    ...
    category: "admin",
    description: "Forças/Fraquezas (ambiente interno) e Oportunidades/Ameaças (ambiente externo), cada item com origem, evidência, impacto, prioridade e confirmação. Exemplos por segmento claramente marcados como exemplo, nunca como fato confirmado.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "pending" },
    last_updated: "2026-07-20",
    notes: "Somente na branch feat/product-engineering-preview-v1. Nenhuma LLM conectada, nenhum preenchimento automático como fato.",
  },
  {
    id: "sales_goals",
  ...
  },
  {
    ...
    category: "admin",
    description: "Cadastro em memória de produtos/serviços (nome, categoria, público, preço, canal, situação: ideia/teste/ativo/sazonal/descontinuado) com campos específicos por segmento (delivery, varejo, clínica, serviços/agência, SaaS).",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "pending" },
    last_updated: "2026-07-20",
    notes: "Somente na branch feat/product-engineering-preview-v1. Nenhuma persistência — tudo em memória durante a sessão.",
  },
  {
    id: "product_cost_engineering",
    name: "Motor LOKAT — Engenharia de Custo por Produto",
    category: "billing",
    description: "src/lib/motor-lokat/product-cost-engine.ts: custo direto, CMV/CSV, margem de contribuição unitária, reaproveitando classifyCostVsGoal/classifyMarginVsGoal do motor financeiro (Sprint 1.0) — nenhuma fórmula duplicada.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "pending" },
    last_updated: "2026-07-20",
    notes: "Somente na branch feat/product-engineering-preview-v1. Verificado via script ad-hoc: margem negativa, dados ausentes e produto sazonal sem NaN/Infinity.",
  },
  {
  ...
  },
  {
    ...
    category: "admin",
    description: "Público principal, faixa de preço, ocasião de consumo, concorrentes, diferencial, praça e promoção por produto — conectado aos 4 Ps da empresa, com exceções próprias por produto quando necessário.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "pending" },
    last_updated: "2026-07-20",
  ...
  },
  {
    ...
    category: "admin",
    description: "Fluxo Ideia → Planejamento → Teste → Resultado → Decisão, reaproveitando CampaignInput/calculateCampaignProjection (Sprint 1.0) para o teste — nenhum segundo simulador financeiro. Decisão sugerida por regras determinísticas (lab-decision-rules.ts), nunca executada automaticamente.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "pending" },
    last_updated: "2026-07-20",
