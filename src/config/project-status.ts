...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  },
  {
    ...
    category: "billing",
    description: "src/lib/motor-lokat/product-cost-engine.ts: custo direto, CMV/CSV, margem de contribuição unitária, reaproveitando classifyCostVsGoal/classifyMarginVsGoal do motor financeiro (Sprint 1.0) — nenhuma fórmula duplicada. Rótulos da UI se adaptam ao tipo do item (produto vs. serviço): serviço não mostra 'Embalagem' e usa 'Retrabalho esperado'/'Deslocamento' em vez de 'Perda esperada'/'Entrega' — a fórmula e o motor não mudam.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "pending" },
    last_updated: "2026-07-22",
    notes: "Somente na branch fix/product-engineering-usability-v1 (base feat/product-engineering-preview-v1). Verificado via script ad-hoc: margem negativa, dados ausentes, produto sazonal e serviço de consultoria (custo por hora) sem NaN/Infinity. Motor não foi alterado neste hotfix — só rótulos de UI e acessibilidade dos campos de composição.",
  },
  {
