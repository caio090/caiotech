...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  },
  {
    ...
    name: "EditorOS",
    category: "conteudo",
    description: "Editor canvas real no navegador: HTML5 Canvas, presets Feed/Story/Carrossel, texto/imagem/forma, move/resize/rotaciona/duplica, undo/redo, zoom, exportação PNG, rascunho localStorage isolado por clientId.",
    phase: "v2",
