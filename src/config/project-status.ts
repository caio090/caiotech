...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  },
  {
    ...
    name: "EditorOS",
    category: "conteudo",
    description: "Editor canvas real no navegador: HTML5 Canvas, presets Feed/Story/Carrossel, texto/imagem/forma, move/resize/rotaciona/duplica, undo/redo, zoom, exportação PNG, rascunho localStorage.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "not_started" },
    sql_dependency: "SQL 87 — design_projects (persistência em nuvem bloqueada até execução)",
    last_updated: "2026-07-14",
    notes: "Motor real: HTML5 Canvas API nativo, sem dependências externas. Persistência: localStorage com label 'Rascunho salvo neste navegador'. Disponível para super_admin via /admin/contentos/criar?tab=editor.",
  },
  {
    id: "rec_os_information_architecture",
    name: "REC OS — Arquitetura de Informação",
    category: "conteudo",
    description: "Navegação reduzida a 5 itens: Visão Geral, Campanhas, ✦ Criar, Calendário, Resultados. Redirects legados. Tabs por URL. Fusão Calendário+Agendamento e Insights+Radar+Relatórios.",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "not_started" },
    last_updated: "2026-07-14",
    notes: "Todos os redirects preservam ?client=. Rotas /producao e /aprovacoes mantidas funcionais fora do nav principal.",
  },
  {
    id: "olaclick_payment_methods",
    name: "OlaClick — Formas de Pagamento",
    category: "integracao",
    description: "extractPaymentEntries(), normalização por tipo, métricas pedidosPorFormaPagamento/faturamentoPorFormaPagamento, endpoint diagnóstico seguro (apenas nomes/tipos de campos).",
    phase: "v2",
    readiness: "qa_pending",
    qa: { status: "not_started" },
    last_updated: "2026-07-14",
    notes: "Diagnóstico em /api/olaclick/payment-methods/diagnostics?client_id=X. Nunca expõe valores, PII ou payload bruto.",
  },
  {
