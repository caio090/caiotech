...
export const PROJECT_AREAS: ProjectAreaStatus[] = [
  ...
  // handoff EditorOS, CRM mobile e app shell responsivo ───────────────────
  {
    ...
    notes: "Ver docs/rec-os/canonical-creative-flow.md. Navegação continua livre (steps clicáveis), não um wizard bloqueante. Ação de envio (Calendário/Produção/Aprovação) continua no passo Destino, antes do Visual Final — compromisso registrado, não decoupado nesta sprint por risco em rotas já integradas.",
    priority: "P1",
  },
  {
  ...
  },
  {
    ...
    category: "conteudo",
    description: "Visão consolidada de produção com 4 visualizações sobre a mesma fonte (bucketContentStatus, src/lib/rec-os-hub.ts).",
    phase: "v2", readiness: "planned", qa: { status: "not_started" },
    last_updated: "2026-08-01",
    notes: "Ver docs/rec-os/production-roadmap.md. Nenhuma tela nova implementada nesta sprint -- priorizados os fixes mobile P0 com evidência real de defeito.",
    priority: "P1",
  },
  {
    ...
    category: "conteudo",
    description: "Visão agregada por cliente (campanhas, conteúdos, aprovações, calendário, arquivos, responsáveis, bloqueios), reaproveitando o isolamento já existente de workspace-visibility-matrix.md.",
    phase: "v2", readiness: "planned", qa: { status: "not_started" },
    last_updated: "2026-08-01",
    notes: "Ver docs/rec-os/client-map.md. Nenhuma tela nova nesta sprint.",
    priority: "P1",
  },
  {
    ...
    phase: "v2", readiness: "planned", qa: { status: "not_started" },
    last_updated: "2026-08-01",
    notes: "Contrato puro testado (parte das 39 asserções de rec-os-workflow.test.ts), mas ainda não conectado a um botão real de navegação do REC OS para o Calendário -- por isso planned, não qa_pending.",
    priority: "P1",
  },
  {
    ...
    category: "conteudo",
    description: "EditorAssetHandoff/isEditorAssetHandoffReady() (contrato estruturado) registrados; handleOpenEditor() real (já existente) confirmado preservando cliente/conteúdo/retorno e nunca abrindo o EditorOS vazio.",
    phase: "v2", readiness: "qa_pending", qa: { status: "pending" },
    last_updated: "2026-08-01",
    notes: "Ver docs/rec-os/editoros-handoff.md. O handoff real hoje usa parâmetros de URL simples, não o objeto estruturado completo do contrato -- migração é próximo passo.",
    priority: "P1",
  },
  {
  ...
  },
  {
    ...
    category: "publico",
    description: "MobileBottomNav (já existente, robusto: máx. 5 itens, safe-area-inset-bottom, drawer Mais) ganhou prop opcional surface -- usa SURFACE_BOTTOM_NAV_PRIMARY (src/lib/mobile-shell/types.ts) filtrado contra os itens já autorizados, nunca concede acesso novo.",
    phase: "v2", readiness: "qa_pending", qa: { status: "pending" },
    last_updated: "2026-08-01",
    notes: "Ver docs/mobile/mobile-app-shell.md. Cobertura parcial declarada: só resolvido com segurança para preview ativo do Super Admin e sessão real de super_admin -- agency/agency_client/direct_business fora de preview ainda caem no padrão anterior (sem regressão, sem diferenciação completa ainda).",
    priority: "P0",
  },
  {
    ...
    category: "publico",
    description: "Botão 'Ação rápida' do dashboard corrigido: full-width no mobile (w-full sm:w-auto), e o PageHeader que o contém agora empilha em coluna no mobile em vez de competir na mesma linha com o título.",
    phase: "v2", readiness: "qa_pending", qa: { status: "pending" },
    last_updated: "2026-08-01",
    notes: "Ver docs/mobile/mobile-app-shell.md. Fluxo de sheet com ações (criar conteúdo/lead/tarefa/evento) do ticket original não implementado -- o botão hoje não abre nada (mesmo comportamento de antes desta sprint, só a posição/largura foram corrigidas).",
    priority: "P0",
  },
  {
