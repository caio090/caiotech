...
const ALLOWLIST: Record<string, { classification: Classification; note: string }> = {
  ...
  "admin/workspaces/preview/exit/route.ts": { classification: "excluded_with_reason", note: "Hotfix 1.0.10 — saída atômica do preview (Set-Cookie + 303 na mesma resposta); mesma natureza de admin/workspaces/preview/route.ts, não uma mutação de dado de negócio" },
